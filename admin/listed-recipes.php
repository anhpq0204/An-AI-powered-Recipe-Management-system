            ...
            <td><?php  echo htmlspecialchars($row['recipePrepTime']);?> Minutes</td>
              ...
              <td><?php  echo htmlspecialchars($row['recipeYields']);?> Serves</td>
                  ...
                  <td><a href="edit-recipe.php?recipeid=<?php echo intval($row['id']);?>" class="btn btn-primary btn-sm">Edit</a>
                    <a href="listed-recipes.php?action=delete&&bsid=<?php echo intval($row['id']); ?>"  title="Delete this record" onclick="return confirm('Do you really want to delete this record?');" class="btn btn-danger btn-sm">Delete </a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
