...
<head>
    <meta charset="UTF-8">
    <title>Food Recipe System | <?php _e('Edit Recipe'); ?></title>
    <script>
...
<section id="main-content">
    <section class="wrapper">
        <h1 class="user-page-title">
            <?php _e('Edit Recipe'); ?>
            <small><?php _e('Update your recipe details'); ?></small>
        </h1>
                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <table class="table table-bordered mb-0" id="dynamic_field">
                                        ...
                                        <tr id="row_exist_<?php echo $idx; ?>">
                                            ...
                                            <td style="width: 100px;">
                                                <?php if($idx == 0): ?>
                                                    <button type="button" name="add" id="add" class="btn btn-success btn-sm"><?php _e('Add More'); ?></button>
                                                <?php else: ?>
                                    ...
                                    <small class="text-muted mt-1 d-block"><?php _e('💡 AI will normalize ingredient names and recalculate calories on update.'); ?></small>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-3">
                                <label class="col-sm-3 col-form-label text-sm-end fw-bold"><?php _e('Current Picture'); ?></label>
                                <div class="col-sm-6">
                                    ...
                                    <small class="text-muted"><?php _e('Leave empty if you don\'t want to change the picture.'); ?></small>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 offset-sm-3">
                                    <button class="btn btn-primary px-4" type="submit" name="update"><?php _e('Update Recipe'); ?></button>
                                </div>
                            </div>

                        </form>
                        <?php else: ?>
                            <p class="text-danger text-center"><?php _e('Recipe not found or you don\'t have permission to edit it.'); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
